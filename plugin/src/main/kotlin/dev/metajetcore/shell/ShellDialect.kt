...
/**
 * Синтаксис одного-единственного действия, которое плагину всё ещё приходится печатать в
 * шелл: снять унаследованные переменные окружения перед запуском агента.
 *
